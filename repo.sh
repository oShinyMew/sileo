...
apt-ftparchive \
		-o APT::FTPArchive::Release::Origin="peroxide's repo'" \
		-o APT::FTPArchive::Release::Label="peroxide's repo'" \
		-o APT::FTPArchive::Release::Suite="stable" \
		-o APT::FTPArchive::Release::Version="1.0" \
		-o APT::FTPArchive::Release::Codename="ios" \
		-o APT::FTPArchive::Release::Architectures="iphoneos-arm iphoneos-arm64" \
		-o APT::FTPArchive::Release::Components="main" \
		-o APT::FTPArchive::Release::Description="hydrogenpero.xide on dsc" \
		release . > Release
